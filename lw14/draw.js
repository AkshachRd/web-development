function drawCartman() {
    ...
    drawCartmanHead(context);
    drawCartmanBody(context);
    drawCartmanLegs(context);
}

function drawCartmanHead(context)
{
    // Голова
...
function drawCartmanBody(context)
{
    // Тело
...
function drawCartmanLegs(context)
{
    // Штаны
...
function drawKenny() {
    ...
    drawKennyBody(context);
    drawKennyLegs(context);
}

function drawKennyHead(context)
{
    // Голова
...
function drawKennyBody(context)
{
    // Тело
...
function drawKennyLegs(context)
{
    // Обувь
